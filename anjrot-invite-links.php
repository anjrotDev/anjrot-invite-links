...
function anjrot_invite_links_block_init() {
	// Registrar bloques solo una vez
...
function anjrot_enqueue_block_editor_assets() {
    wp_enqueue_script(
        'anjrot-custom-form-editor-script',
        plugins_url('build/custom-form/index.js', __FILE__),
        array('wp-blocks', 'wp-element', 'wp-editor', 'wp-components', 'wp-i18n'),
        filemtime(plugin_dir_path(__FILE__) . 'build/custom-form/index.js')
    );
}
add_action('enqueue_block_editor_assets', 'anjrot_enqueue_block_editor_assets');
